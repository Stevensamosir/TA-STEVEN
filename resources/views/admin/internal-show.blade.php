...
<div class="pt-4 space-y-4">
    <a href="{{ route('admin.internal') }}" class="text-sm text-del hover:underline inline-flex items-center gap-1">
        &larr; Kembali ke Data Internal
    </a>
