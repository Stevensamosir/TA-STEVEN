...
<section class="bg-gradient-to-br from-del to-del-light text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-2xl">
            <h1 class="text-4xl font-bold mb-4 leading-tight" style="font-family:'Playfair Display',serif;">Profil Dosen<br>Fakultas Vokasi</h1>
            <p class="text-blue-100 text-lg mb-8">Temukan dosen-dosen terbaik kami beserta rekam jejak akademik mereka.</p>
            <form action="{{ route('home') }}" method="GET" class="flex flex-col sm:flex-row gap-3">
                ...
                <select name="prodi" class="px-4 py-3 rounded-xl text-gray-800 text-sm bg-white min-w-[160px]">
